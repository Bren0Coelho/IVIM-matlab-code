function  [D_diff_est, D_perf_est, f_est] = NLLS_LM(M_noise, b, x0, D_diff_est_lls, f_est_lls)
...
% ========================================================================
% ========================================================================
% Levenberg-Marquadt square with biexponential model (y = alpha*exp(x*w) + beta*exp(x*z))
...
% OUTPUT: f_est_lm = perfusion fraction
%         D_diff_est_lm = diffusion coefficient [mm²/s]
%         D_perf_est_lm = pseudodiffusion coefficient [mm²/s]
